export default function AiAdviceLayout() {
    return <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        <div className="group rounded-2xl hover:scale-105 transition-all duration-300 border border-white/10 bg-zinc-900/40 p-6 backdrop-blur-xl shadow-xl transition-all hover:bg-white/5 hover:border-white/20">
        ...
        <div className="group rounded-2xl hover:scale-105 transition-all duration-300 border border-white/10 bg-zinc-900/40 p-6 backdrop-blur-xl shadow-xl transition-all hover:bg-white/5 hover:border-white/20 border-indigo-500/20">
