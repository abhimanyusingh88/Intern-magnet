...
type ExpandMinimizeProps = {
    expand: boolean,
    setExpand: any,
}
export default function ExpandMinimize({ expand, setExpand }: ExpandMinimizeProps) {
    return <div className="text-zinc-200  cursor-pointer relative  ">
